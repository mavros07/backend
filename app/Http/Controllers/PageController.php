...
class PageController extends Controller
{
    ...
    public function about()
    {
        ...
        $sections = $this->pageSections('about', [
            ...
            'hero_primary_cta_text' => 'Browse Inventory',
            'hero_primary_cta_href' => '/inventory',
            'hero_secondary_cta_text' => 'Contact',
            'hero_secondary_cta_href' => '/contact',

            'welcome_image' => 'asset/images/media/about-welcome.jpg',
            'welcome_title' => 'Welcome to Motors',
            'welcome_subtitle' => 'Before we get ahead of ourselves, we want to welcome you. While nothing can replace the on-the-lot experience…',
            'welcome_body' => 'Our goal is to give you an interactive tour of our inventory, as well as allow you to conveniently get a quote, schedule a service appointment, or apply for financing.',
            'welcome_signature' => '— Mikey Diokles, President',

            'values_image' => 'asset/images/media/about-values.jpg',
            'values_title' => 'Core Values',
            'values_body' => 'We go through extensive training so that we may provide you with the knowledge you need to choose the vehicle that is right for your lifestyle.',
            'values_list' => "Stress-free finance department.\nRobust selection of popular vehicles.\nTrusted by thousands of shoppers.\nService & maintenance you can rely on.",
            ...
            'testimonial_1_title' => 'Vestibulum laoreet eu lorem vel tempor',
            'testimonial_1_body' => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. In fringilla, velit id laoreet hendrerit, sapien nisl varius dolor, eu consequat erat augue in eros.',
            'testimonial_1_author' => 'John Doe',
            'testimonial_1_brand' => 'Toyota',
            'testimonial_2_title' => 'Pellentesque non turpis ut est',
            'testimonial_2_body' => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. In fringilla, velit id laoreet hendrerit, sapien nisl varius dolor, eu consequat erat augue in eros.',
            'testimonial_2_author' => 'Alice Smart',
            'testimonial_2_brand' => 'BMW',
            'testimonial_3_title' => 'Nam condimentum pellentesque augue',
            'testimonial_3_body' => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. In fringilla, velit id laoreet hendrerit, sapien nisl varius dolor, eu consequat erat augue in eros.',
