...
class PageController extends Controller
{
    ...
    public function faq()
    {
        ...
        $sections = $this->pageSections('faq', [
            ...
            'faq_1_1_q' => 'Can I reserve a vehicle before visiting the dealership?',
            'faq_1_1_a' => 'Yes. We offer a digital reservation service where you can place a fully refundable deposit on any vehicle for up to 48 hours.',
            'faq_1_2_q' => 'What kind of inspection do vehicles undergo?',
            'faq_1_2_a' => 'Every vehicle in our inventory passes a rigorous 172-point Certification process by factory-trained technicians.',
            'faq_1_3_q' => 'Do you offer nationwide shipping?',
            'faq_1_3_a' => 'Absolutely. We utilize specialized enclosed carriers to ship vehicles anywhere in the continental United States.',
            'cat_2_title' => 'Financing & Trade',
            'cat_2_icon' => 'payments',
            'faq_2_1_q' => 'How is my trade-in value determined?',
            'faq_2_1_a' => 'We use real-time market data alongside a physical appraisal to provide the most competitive value.',
            'faq_2_2_q' => 'Do you work with luxury-specific lenders?',
            'faq_2_2_a' => 'Yes, our finance department partners with premier financial institutions that understand high-value vehicle assets.',
            'cat_3_title' => 'Performance Service',
            'cat_3_icon' => 'build_circle',
            'faq_3_1_q' => 'What performance tuning services do you offer?',
            'faq_3_1_a' => 'From stage 1 ECU remapping to full exhaust systems and suspension setups, our specialists handle it all.',
            'cat_4_title' => 'Selling to Apex',
            'cat_4_icon' => 'sell',
            'faq_4_1_q' => 'What documents are needed to sell my car?',
            'faq_4_1_a' => 'You\'ll need the title, valid ID, and maintenance records. Our team handles all transfer paperwork for you.',
