            ...
            <section class="rounded-lg border border-gray-200 p-4 space-y-4">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                  ...
                  <x-text-input id="finance_min_down_payment" name="finance_min_down_payment" type="number" class="mt-1 block w-full" value="{{ old('finance_min_down_payment') }}" />
                </div>
                <div>
                  <x-input-label for="finance_term_min_months" value="Loan term min (months)" />
                  <x-text-input id="finance_term_min_months" name="finance_term_min_months" type="number" class="mt-1 block w-full" value="{{ old('finance_term_min_months') }}" />
                </div>
                <div>
                  <x-input-label for="finance_term_max_months" value="Loan term max (months)" />
                  <x-text-input id="finance_term_max_months" name="finance_term_max_months" type="number" class="mt-1 block w-full" value="{{ old('finance_term_max_months') }}" />
                </div>
              </div>
